...
class UserDisplayWrapper {
  ...
  freeze(own = false, checkConsistency = false) {
    ...
    for (let i = 0; i < this._wrapperFields.entries.data.length; i++) {
      this._refObject.entries[i] = this._wrapperFields.entries.data[i];
    }
  }
  serialize() {
  ...
  deserialize(refObject) {
    ...
    this._refObject.entries = refObject.entries;
    this._wrapperFields.entries.fill(refObject.entries.toArray());
    this._selected_entryIntialized = true;
  ...
  static freeStruct(refObject) {
    ...
    StringWrapper.freeStruct(refObject.entries);
  }
