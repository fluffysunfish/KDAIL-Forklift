...
class StaticSLAM(Node):
    def __init__(self):
        ...
        # Timer for publishing map (faster updates)
        ...
        self.decay_factor = 0.8        # How quickly to forget old observations (higher value = faster updates)
        self.update_count = 0
        self.recent_scans_weight = 5.0  # Weight recent scans more heavily
        self.scan_buffer_size = 1       # Number of recent scans to keep for comparison
    ...
    def scan_callback(self, msg):
        ...
        for i, distance in enumerate(msg.ranges):
            ...
            if 0 <= map_x < self.map_width and 0 <= map_y < self.map_height:
                # Mark endpoint as occupied with higher weight for faster map updates
                # Always apply higher weight to make updates happen faster
                weight = self.recent_scans_weight
